...
describe("createD1Store — defence-in-depth against corrupted rows", () => {
  it("re-derives isStateChanging on read, ignoring a corrupted stored value", async () => {
  ...
  it("fails loudly on a corrupt expiresAt instead of producing an immortal gate", async () => {
